...
/////////
    ...
    public static class Edge<T extends Comparable<T>> implements Comparable<Edge<T>> {
        ...
        public Edge(T vertexB, int weight) {
...
//////////////
	...
	public Station[] getNeighbors(Station currentStation) {
    		   List<Station> neighbors = adjacencyList.getOrDefault(currentStation, new ArrayList<>());
    	        return neighbors.toArray(new Station[0]);
	}
}